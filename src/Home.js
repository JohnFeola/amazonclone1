  ...
  return (
    <div className='home'>
        <div className='home__container'>
            ...
            <Product title="Software Engineering Intern : John Feola"
                price={15.00} image="https://i.postimg.cc/90jsv52n/linked-in-profile-pic-2.png"
                rating={5} />
            </div>

            <div className='home__row'>
            <Product title="The Innovators: How a Group of Hackers, Genuises, and Geeks Created the Digital Revolution"
                ...
                rating={5} />
                 <Product title="The Mobile Wave: How Mobile Intelligence Will Change Everything"
                price={12.99} image="https://m.media-amazon.com/images/I/41J7ksCzCEL._SX325_BO1,204,203,200_.jpg"
                rating={5} />
                <Product title="The Computer Book: From the Abacus to Artificial Intelligence"
            ...
            <Product title="Steve Jobs"
                ...
                rating={5} />
                  <Product title="The Bitcoin Standard: The Dencentralized Alternative to Central Banking"
